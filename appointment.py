...
st.title("Appointment Booking Portal")
...
def appointment():
	with st.form(key='appointment_form'):
		...
		expiry_date=st.date_input("When do you want come and donate blood we will book that slot for you.",datetime.date(2020, 7, 10))
		terms_condition= st.checkbox('I agree to terms and conditions')
	...
	if submit_button:
		...
		st.write("Appointment is booked")
